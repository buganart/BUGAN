...
config_dict = {
    ...
    "num_classes": 0,
    "trim_class_offset": 0,
    "history_checkpoint_frequency": 6,
    "vae_opt": "Adam",
    "dis_opt": "Adam",
    "label_loss": "BCELoss",
    "rec_loss": "MSELoss",
    ...
    "FMgan_coef": 100,
    "z_size": 128,
    "decoder_num_layer_unit": [64, 128, 128, 128, 128, 64],
    "encoder_num_layer_unit": [32, 64, 64, 64, 64, 32],
    "dis_num_layer_unit": [32, 64, 64, 64, 64, 32],
    "batch_size": 32,
    "resolution": 64,
    "log_interval": 20,
    "log_num_samples": 3,
